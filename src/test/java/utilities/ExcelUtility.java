...
public class ExcelUtility {
    ...
    public static int getRowCount(String sheetName) throws IOException, IOException
    {
    ...
    public static int getCellCount(String sheetName, int rownum) throws IOException, IOException {
        fi=new FileInputStream(path);
        workbook=new XSSFWorkbook(fi);
        sheet=workbook.getSheet(sheetName);
